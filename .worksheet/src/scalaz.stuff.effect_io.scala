...
object effect_io {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(187); 

  val action1 = for {
    _ <- putStrLn("Hello, world!")
  } yield ();System.out.println("""action1  : scalaz.effect.IO[Unit] = """ + $show(action1 ));$skip(29); 
  
  action1.unsafePerformIO;$skip(166); 
  ...
  };System.out.println("""action2  : scalaz.effect.IO[String] = """ + $show(action2 ));$skip(29); val res$0 = 
  
  action2.unsafePerformIO;System.out.println("""res0: String = """ + $show(res$0));$skip(117); 
  
  
  val action3 = IO {
    val source = scala.io.Source.fromFile("eclipse.ini")
    source.getLines.toStream
  };System.out.println("""action3  : scalaz.effect.IO[scala.collection.immutable.Stream[String]] = """ + $show(action3 ));$skip(36); val res$1 = 
