...
object Poly {
  ...
  def pairApply(f: Set ~> Option) = (f(Set(1, 2, 3)), f(Set('a', 'b', 'c')));System.out.println("""pairApply: (f: shapeless.poly.~>[Set,Option])(Option[Int], Option[Char])""");$skip(20); val res$2 = 
  pairApply(choose);System.out.println("""res2: (Option[Int], Option[Char]) = """ + $show(res$2));$skip(176); val res$3 = 
  ...
  };System.out.println("""res3: List[Option[Int]] = """ + $show(res$3));$skip(392); val res$4 = 
