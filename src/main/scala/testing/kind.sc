...
object kind {
  ...
  kind[List.type]                                 //> res6: String = List's kind is * -> *. This is a type constructor: a 1st-ord
                                                  //| er-kinded type.
  kind[Applicative.type]                          //> res7: String = Applicative's kind is (* -> *) -> *. This is a type construc
                                                  //| tor that takes type constructor(s): a higher-kinded type.
  kind[Unapply.type]                              //> res8: String = Unapply's kind is ((* -> *) -> *) -> * -> *. This is a type 
