...
object kind {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(1042); 
  ...
  kind[Functor.type];System.out.println("""res5: String = """ + $show(res$5))}
}
